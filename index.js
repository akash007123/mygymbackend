...
await transporter.sendMail({
  ...
  <div style="font-family: Arial, sans-serif; max-width: 500px; margin: auto; border:1px solid #eee; border-radius:8px; overflow:hidden;">
    <div style="background: #18181b; padding: 24px 0; text-align: center;">
      ...
      <h2 style="color: #fff; margin: 0;">Powerfit Gym</h2>
    </div>
    <div style="padding: 24px; background: #fff;">
      <h3 style="color: #18181b;">Hi ${name},</h3>
      <p>Thank you for reaching out to <b>Powerfit Gym</b>! We have received your message and will get back to you soon.</p>
      <div style="background: #f4f4f5; padding: 16px; border-radius: 6px; margin: 16px 0;">
        <b>Your message:</b>
        <div style="color: #52525b; margin-top: 8px;">${message}</div>
      </div>
      <p style="margin-bottom: 0;">Best regards,<br/>Powerfit Team</p>
    </div>
    <div style="background: #f4f4f5; padding: 16px; text-align: center; font-size: 14px; color: #52525b;">
      <div>
        <b>Contact us:</b><br/>
        <a href="tel:5551234567" style="color: #18181b; text-decoration: none;">(555) 123-4567</a> |
        <a href="mailto:info@powerfit.com" style="color: #18181b; text-decoration: none;">info@powerfit.com</a>
      </div>
      <div>
        <a href="https://powerfit.com" style="color: #18181b; text-decoration: none;">www.powerfit.com</a>
      </div>
...
await transporter.sendMail({
  ...
  <div style="font-family: Arial, sans-serif; max-width: 500px; margin: auto; border:1px solid #eee; border-radius:8px; overflow:hidden;">
    ...
    <div style="padding: 24px; background: #fff;">
      <h3 style="color: #18181b;">New Contact Submission</h3>
      <p><b>Name:</b> ${name}</p>
      <p><b>Email:</b> ${email}</p>
      <p><b>Phone:</b> ${phone}</p>
      <div style="background: #f4f4f5; padding: 16px; border-radius: 6px; margin: 16px 0;">
      ...
      <p style="margin-bottom: 0;">Check the admin dashboard for more details.</p>
    </div>
    <div style="background: #f4f4f5; padding: 16px; text-align: center; font-size: 14px; color: #52525b;">
      <div>
        <b>Contact us:</b><br/>
